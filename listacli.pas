...
var
  f_listacli: Tf_listacli;

implementation

{$R *.fmx}

uses u_dm, caduser, cidade, clientes, listauser, listcid, login, menu;

procedure Tf_listacli.bt_cadcidClick(Sender: TObject);
begin
f_cidade.Show;
end;

procedure Tf_listacli.bt_cadcliClick(Sender: TObject);
begin
f_cliente.Show;
end;

procedure Tf_listacli.bt_excluircontaClick(Sender: TObject);
begin
...
procedure Tf_listacli.bt_homeClick(Sender: TObject);
begin
tela_menu.Show;
end;

procedure Tf_listacli.bt_listcidClick(Sender: TObject);
begin
         f_listacid.Show;
end;

procedure Tf_listacli.bt_listuserClick(Sender: TObject);
begin
f_listauser.Show;
end;

procedure Tf_listacli.Button2Click(Sender: TObject);
begin
Application.Terminate;
end;

procedure Tf_listacli.FormActivate(Sender: TObject);
begin
